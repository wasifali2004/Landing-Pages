...
import { ChevronRight, MapPin, CreditCard, DollarSign, Download, X } from 'lucide-react';
...
export default function PropertyShowcaseFull() {
  ...
  return (
    <div className="font-sans">
        ...
        <div className="w-full lg:w-1/2 relative overflow-hidden order-1 lg:order-2">
          <div className={`h-full transition-all duration-1500 ${isVisible ? 'scale-100 opacity-100' : 'scale-110 opacity-0'}`}>
            <div className="bg-blue-500 h-full w-full min-h-64 lg:min-h-full">
              {/* You would need to replace this with your actual image import */}
            ...
            <div className="w-full lg:w-1/2 relative overflow-hidden order-1">
              <div className={`transition-all duration-1000 transform ${isAboutVisible ? 'scale-100 opacity-100' : 'scale-110 opacity-0'}`}>
                ...
                <div className="bg-blue-100 rounded-lg h-64 md:h-96 lg:h-full min-h-64 w-full flex items-center justify-center relative overflow-hidden">
                  <p className="text-blue-500 text-xl">Aerial Image Will Be Added Here</p>
            ...
            <div className="w-full lg:w-1/2 order-2 flex flex-col justify-center">
              <div className={`transition-all duration-700 transform ${isAboutVisible ? 'translate-y-0 opacity-100' : 'translate-y-10 opacity-0'}`}>
                ...
                <div className="mt-10 flex flex-col sm:flex-row gap-4">
                  <button 
                    className={`bg-gray-900 hover:bg-black text-white font-medium py-3 px-6 rounded-md transition-all duration-300 flex items-center justify-center gap-2 transform hover:scale-105 hover:shadow-lg ${isAboutVisible ? 'translate-y-0 opacity-100 delay-400' : 'translate-y-10 opacity-0'}`}
                  >
                    <Download size={18} />
                    DOWNLOAD BROCHURE
                  </button>
                  ...
                  <button 
                    onClick={handleRegisterClick}
                    className={`bg-white border-2 border-gray-900 hover:bg-gray-100 text-gray-900 font-medium py-3 px-6 rounded-md transition-all duration-300 flex items-center justify-center gap-2 group transform hover:scale-105 hover:shadow-lg ${isAboutVisible ? 'translate-y-0 opacity-100 delay-500' : 'translate-y-10 opacity-0'}`}
                  >
                    DISCOVER MORE
      ...
      >
        <div className="bg-green-500 p-3 rounded-full shadow-lg cursor-pointer hover:bg-green-600 transition-all duration-300 hover:scale-110 animate-pulse">
      ...
      {showPopup && (
        <div className="fixed inset-0 bg-black bg-opacity-50 z-50 flex items-center justify-center p-4">
          <div 
            className="bg-white rounded-lg shadow-xl w-full max-w-2xl relative animate-fadeIn overflow-auto max-h-screen"
            style={{
          ...
          >
            ...
            <div className="p-6 md:p-8">
              ...
              <p className="text-center text-gray-600 mb-8">Leave your contact details below to register your interest</p>
              ...
              <form onSubmit={handleSubmit}>
                <div className="grid grid-cols-1 md:grid-cols-2 gap-4 mb-6">
                  <div>
                    <input 
                      ...
                      className={`w-full border ${formErrors.fullName ? 'border-red-500' : 'border-gray-300'} rounded-md p-3 focus:outline-none focus:ring-2 focus:ring-blue-500`}
                  ...
                  <div>
                    <input 
                      ...
                      name="email"
                      placeholder="Email" 
                      className={`w-full border ${formErrors.email ? 'border-red-500' : 'border-gray-300'} rounded-md p-3 focus:outline-none focus:ring-2 focus:ring-blue-500`}
                ...
                <div className="grid grid-cols-1 md:grid-cols-2 gap-4 mb-6">
                  <div>
                    <input 
                      ...
                      className={`w-full border ${formErrors.phone ? 'border-red-500' : 'border-gray-300'} rounded-md p-3 focus:outline-none focus:ring-2 focus:ring-blue-500`}
                  ...
                  <div>
                    <input 
                      ...
                      className={`w-full border ${formErrors.country ? 'border-red-500' : 'border-gray-300'} rounded-md p-3 focus:outline-none focus:ring-2 focus:ring-blue-500`}
                ...
                <div className="mb-6">
                  <textarea 
                    ...
                    placeholder="Message" 
                    rows="4"
                    className={`w-full border ${formErrors.message ? 'border-red-500' : 'border-gray-300'} rounded-md p-3 focus:outline-none focus:ring-2 focus:ring-blue-500`}
                ...
                <button 
                  type="submit"
                  className="w-full bg-blue-800 hover:bg-blue-900 text-white font-medium py-3 rounded-md transition-all duration-300 hover:shadow-lg"
                >
                  SUBMIT
                </button>
              </form>
