...
const amenities = [
  { icon: '/icons/pool.webp', label: 'Swimming Pool' },
  { icon: '/icons/fitness.webp', label: 'Fitness Centre' },
  { icon: '/icons/supermarket.webp', label: 'Supermarket' },
  { icon: '/icons/restaurant.webp', label: 'Restaurants' },
  { icon: '/icons/golf.webp', label: 'Golf Course' },
  { icon: '/icons/jogging.webp', label: 'Jogging Track' },
  { icon: '/icons/kids-play.webp', label: 'Kids Play Area' },
  { icon: '/icons/sport.webp', label: 'Sport Facilities' },
];
...
const AmenitiesSection = () => {
  ...
  return (
    <div className="w-full py-12 bg-white px-4 md:px-10">
      <h2 className="text-3xl md:text-4xl font-bold text-center text-[#071F4A] mb-4">
        Binghatti Skyrise Amenities
      </h2>
      <p className="text-center text-gray-600 max-w-3xl mx-auto mb-10">
        Binghatti Skyrise offers an array of world-class amenities, including a swimming pool,
        fine dining, and a scenic golf course. Fitness enthusiasts can enjoy tennis, paddle, and
        basketball courts, a jogging track, a man-made beach, landscaped gardens, and both indoor
        and outdoor workout areas.
      </p>
      ...
      <div className="grid grid-cols-2 md:grid-cols-4 gap-6 max-w-6xl mx-auto">
        {amenities.map((item, index) => (
          <div
            key={index}
            className="bg-white p-6 rounded-xl shadow hover:shadow-md transition-all duration-300 flex flex-col items-center justify-center text-center"
          >
      ...
      <div className="text-center mt-12">
        <button 
          className="bg-[#071F4A] hover:bg-[#0a2a60] text-white font-semibold py-3 px-8 rounded-full shadow-lg transition-all duration-300 text-lg cursor-pointer"
